...
namespace MurbongMacroV2
{
    ...
    public class Class_DD
    {
        ...
        public delegate Int32 DD_MouseMove(IntPtr hwnd, Int32 x, Int32 y);
        public delegate Int32 DD_SnapPic(IntPtr hwnd, Int32 x, Int32 y, Int32 w, Int32 h);
        public delegate Int32 DD_PickColor(IntPtr hwnd, Int32 x, Int32 y, Int32 mode);
        ...
        private int GetDDfunAddress(IntPtr hwnd)
        {
            ...
            if (!pFuncAddr.Equals(IntPtr.Zero)) MouseMove = Marshal.GetDelegateForFunctionPointer(pFuncAddr, typeof(DD_MouseMove)) as DD_MouseMove;

            pFuncAddr = GetProcAddress(hwnd, "DD_SnapPic");
            if (!pFuncAddr.Equals(IntPtr.Zero)) SnapPic = Marshal.GetDelegateForFunctionPointer(pFuncAddr, typeof(DD_SnapPic)) as DD_SnapPic;

            pFuncAddr = GetProcAddress(hwnd, "DD_PickColor");
            if (!pFuncAddr.Equals(IntPtr.Zero)) PickColor = Marshal.GetDelegateForFunctionPointer(pFuncAddr, typeof(DD_PickColor)) as DD_PickColor;

            pFuncAddr = GetProcAddress(hwnd, "DD_GetActiveWindow");
            if (!pFuncAddr.Equals(IntPtr.Zero)) GetActiveWindow = Marshal.GetDelegateForFunctionPointer(pFuncAddr, typeof(DD_GetActiveWindow)) as DD_GetActiveWindow;
